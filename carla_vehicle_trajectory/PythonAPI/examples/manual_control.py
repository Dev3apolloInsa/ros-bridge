...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            # set the starting position coordonnates 
            spawn_point = carla.Transform(carla.Location(x=10, y=2.5, z=0.5), carla.Rotation())          
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
            self.show_vehicle_telemetry = False
            self.modify_vehicle_physics(self.player)
        # Set up the sensors.
...
#----------------Pour dessiner les points d'apparutions  sur la carte-------------------#        
...
#----------------  fin de l'ajout -----------------------------#   
        ...
        while True:
            ...
            #pygame.draw.circle(display, BLACK, (20,2), radius, 3)
            #pygame.draw.line(display, BLACK, (0, 100), (args.width, 80))
            pygame.display.flip()
